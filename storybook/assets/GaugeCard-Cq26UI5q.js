import{bR as r}from"./iframe-C22Bdc8U.js";import{G as p}from"./Gauge-YhcEjzWL.js";import{B as v}from"./Box-kBWWZnJr.js";import{I as y}from"./InfoCard-DvJ85-Ue.js";import{m as b}from"./makeStyles-pc3OoPEq.js";const q=b({root:{height:"100%",width:250},rootSmall:{height:"100%",width:160}},{name:"BackstageGaugeCard"});function f(n){const t=q(n),{title:i,subheader:a,progress:u,inverse:s,deepLink:o,description:g,icon:l,variant:d,alignGauge:m="normal",size:e="normal",getColor:c}=n,k={inverse:s,description:g,getColor:c,value:u};return r.jsx(v,{className:e==="small"?t.rootSmall:t.root,children:r.jsx(y,{title:i,subheader:a,deepLink:o,variant:d,alignContent:m,icon:l,titleTypographyProps:{...e==="small"?{variant:"subtitle2"}:void 0},subheaderTypographyProps:{...e==="small"?{variant:"body2"}:void 0},children:r.jsx(p,{...k,size:e})})})}f.__docgenInfo={description:`{@link Gauge} with header, subheader and footer
