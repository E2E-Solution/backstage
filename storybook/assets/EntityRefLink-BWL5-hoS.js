import{ca as a,bR as i}from"./iframe-C22Bdc8U.js";import{a as y,e as f}from"./routes-Cs3iaclI.js";import{L as m}from"./Link-CQ8YmDr-.js";import{u as g}from"./useRouteRef-DerxvSo0.js";import{E as b}from"./EntityDisplayName-XHNXyi2c.js";const w=a.forwardRef((e,t)=>{const{entityRef:n,defaultKind:r,defaultNamespace:s,title:o,children:l,hideIcon:d,disableTooltip:h,...c}=e,p=v(),u=l??o??i.jsx(b,{entityRef:n,defaultKind:r,defaultNamespace:s,hideIcon:d,disableTooltip:h});return i.jsx(m,{...c,ref:t,to:p(e.entityRef),children:u})});function v(){const e=g(y);return a.useCallback(t=>{const n=f(t,{encodeParams:!0});return e(n)},[e])}w.__docgenInfo={description:`Shows a clickable link to an entity.
