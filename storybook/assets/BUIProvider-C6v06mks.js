import{ca as i,b6 as u,bR as t,B as o,cN as c,cQ as p}from"./iframe-C22Bdc8U.js";import{i as m}from"./openLink-BOxlnep2.js";import{u as l}from"./useResolvedHref-B-JSyBiI.js";function d(n){const{useAnalytics:e,children:a}=n,s=i.useMemo(()=>u({1:{useAnalytics:e}}),[e]),r=t.jsx(o.Provider,{value:s,children:a});return c()?t.jsx(g,{children:r}):r}function g({children:n}){const e=p();return t.jsx(m,{navigate:e,useHref:l,children:n})}d.__docgenInfo={description:`Provides integration capabilities to all descendant BUI components.
