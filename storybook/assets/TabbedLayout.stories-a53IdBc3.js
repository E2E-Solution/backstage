import{ca as b,bR as e,cS as f,cU as x,bX as R,w as g,X as j,W as L}from"./iframe-C22Bdc8U.js";import{H as v}from"./Helmet-B5dcEhA-.js";import{L as E}from"./Link-CQ8YmDr-.js";import{H as w}from"./HeaderTabs-B1jnYg5u.js";import{C as P}from"./Content-BmOkdHT2.js";import{a as S}from"./componentData-Czz8KrGb.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DK7MulBS.js";import"./lodash-CzCsWA5n.js";import"./useAnalytics-CJt-GhI1.js";import"./makeStyles-pc3OoPEq.js";import"./useApp-BHKH8xjY.js";import"./Box-kBWWZnJr.js";import"./styled-B08B7Ia3.js";import"./Tabs-DXWJbIhB.js";import"./index-B9sM2jn7.js";import"./KeyboardArrowRight-Dl0qXHdx.js";function _(t){const a=f(),s=t.map(({path:r,children:m})=>({caseSensitive:!1,path:`${r}/*`,element:m})).sort((r,m)=>m.path.replace(/\/\*$/,"").localeCompare(r.path.replace(/\/\*$/,""))),d=x(s)??t[0]?.children;let n=a["*"]??"";n.startsWith("/")||(n=`/${n}`);const[i]=R(s,n)??[],p=i?t.findIndex(r=>`${r.path}/*`===i.route.path):0;return{index:p===-1?0:p,element:d,route:t[p]??t[0]}}function y(t){const{routes:a}=t,{index:o,route:s,element:d}=_(a),n=b.useMemo(()=>a.map(i=>{const{path:p,title:r,tabProps:m}=i;let l=p;return l=l.replace(/\/\*$/,""),l=l.replace(/^\//,""),{id:p,label:r,tabProps:{component:E,to:l,...m}}}),[a]);return e.jsxs(e.Fragment,{children:[e.jsx(w,{tabs:n,selectedIndex:o}),e.jsxs(P,{children:[e.jsx(v,{title:s?.title}),d]})]})}y.__docgenInfo={description:"",methods:[],displayName:"RoutedTabs",props:{routes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  path: string;
  title: string;
